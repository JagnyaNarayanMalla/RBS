...
def bill_button_operation():
    ...
    if ans=="yes":
        ...
        st = "\t\t\t\tJAGNYA NARAYAN MALLA Hotel\n\t\t\tBERHAMPUR, GANJAM-761003\n"
...
root.title("Welcome to Malla Hotel")
...
title_label = Label(title_frame, text="WELCOME TO JAGNYA NARAYAN MALLA, RESTAURANTS BILLING SYSTEM", 
                    font=("times new roman", 22, "bold"),bg = "#074463", fg="white", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 18, "bold"),
                            bd=6, bg="lightblue", relief=GROOVE)
...
customer_contact_label = Label(customer_frame, text="Contact No.", 
                    font=("arial", 15, "bold"),bg = "lightblue", fg="blue")
...
#......................
customer_name_label = Label(customer_frame, text="Bill No.", 
                    font=("arial", 15, "bold"),bg = "lightblue", fg="blue")
...
item_title_label = Label(item_frame, text="Your Item", 
...
item_rate_label = Label(item_frame2, text="Rate(Rs.)", 
                    font=("arial", 12, "bold"),bg = "lightgreen", fg="blue")
...
order_tabel.heading("rate",text="Rate (Rs.)")
order_tabel.heading("quantity",text="Quantity")
order_tabel.heading("price",text="Price(Rs.)")
